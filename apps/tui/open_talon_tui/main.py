...
-----
  cd apps/tui
  python -m open_talon_tui.main                           # default http://localhost:8000
  python -m open_talon_tui.main --gateway http://host:8000
  python -m open_talon_tui.main --api-key <key>
  python -m open_talon_tui.main --openbao-token <token>
