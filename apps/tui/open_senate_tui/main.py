...
-----
  cd apps/tui
  python -m open_senate_tui.main                           # default http://localhost:8000
  python -m open_senate_tui.main --gateway http://host:8000
  python -m open_senate_tui.main --api-key <key>
  python -m open_senate_tui.main --openbao-token <token>
