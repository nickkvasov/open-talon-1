...
def _mock_api_key_backend(monkeypatch):
    ...
    monkeypatch.setattr("app.auth.api_key.create_api_key", _create)
    monkeypatch.setattr("app.auth.api_key.list_api_keys",  _list)
    monkeypatch.setattr("app.auth.api_key.revoke_api_key", _revoke)
    monkeypatch.setattr("app.routers.admin.create_api_key", _create)
    monkeypatch.setattr("app.routers.admin.list_api_keys",  _list)
    monkeypatch.setattr("app.routers.admin.revoke_api_key", _revoke)
    return _store
