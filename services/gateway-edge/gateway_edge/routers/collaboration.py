...
from open_talon_contracts.models import normalize_organization_slug, plugin_metadata_enables_asset_persistence
...
def _plugin_attachment_enables_asset_persistence(metadata: dict | None) -> bool:
    return plugin_metadata_enables_asset_persistence(metadata)
...
@router.post(
    ...
    summary="Create a methodology blueprint and start a dossier",
)
...
@router.get(
    "/organizations/{organization_id}/methodology/blueprints/{blueprint_id}/research-state",
    response_model=MethodologyResearchState,
    summary="Get methodology dossier research console state",
)
async def get_methodology_research_state(
    ...
    try:
        state = await collab_svc.collaboration_service.get_methodology_research_state(
            blueprint_id,
            actor=_request_actor_if_oidc(request),
        )
        _require_resource_in_organization(
            ...
            resource_id=blueprint_id,
            organization_id=organization_id,
            resource_organization_id=state.blueprint.organization_id,
        )
        return state
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.post(
    "/organizations/{organization_id}/methodology/blueprints/{blueprint_id}/research-requests",
    response_model=MethodologyResearchState,
    summary="Request or refine Researcher-led methodology research",
)
async def create_methodology_research_request(
    ...
    try:
        existing = await collab_svc.collaboration_service.get_methodology_blueprint_detail(
            blueprint_id,
            actor=payload.actor,
        )
        _require_resource_in_organization(
            ...
            resource_id=blueprint_id,
            organization_id=organization_id,
            resource_organization_id=existing.blueprint.organization_id,
        )
        state = await collab_svc.collaboration_service.create_methodology_research_request(
            blueprint_id,
            payload,
        )
        _require_resource_in_organization(
...
@router.post(
    "/organizations/{organization_id}/methodology/blueprints/{blueprint_id}/versions",
    response_model=MethodologyBlueprintDetail,
    summary="Create a new editable methodology blueprint version",
)
async def create_methodology_blueprint_version(
    ...
    try:
        ...
        detail = await collab_svc.collaboration_service.create_methodology_blueprint_version(
            blueprint_id,
            payload,
        )
        _require_resource_in_organization(
...
@router.delete(
    "/organizations/{organization_id}/methodology/blueprints/{blueprint_id}",
    response_model=dict,
    summary="Archive a methodology blueprint",
)
async def archive_methodology_blueprint(
    request: Request,
    organization_id: UUID,
    blueprint_id: UUID,
    payload: DeleteMethodologyBlueprintRequest = Body(...),
) -> dict[str, bool | str]:
    await _require_identity_permission(
        request,
        permission="methodology.write",
    ...
    try:
        ...
        return await collab_svc.collaboration_service.archive_methodology_blueprint(
            blueprint_id,
            payload,
        )
    except Exception as exc:
...
async def apply_methodology_blueprint(
    ...
    payload = payload.model_copy(
        update={
            ...
            or _resolve_organization_actor(request, payload.actor)
        }
    )
    try:
        detail = await collab_svc.collaboration_service.get_methodology_blueprint_detail(
...
@router.get(
    "/organizations/{organization_id}/dossiers/{dossier_id}",
    response_model=Dossier,
    summary="Get a dossier",
)
...
@router.get(
    "/organizations/{organization_id}/dossiers/{dossier_id}/sources",
    response_model=list[DossierSource],
    summary="List dossier sources",
)
async def list_dossier_sources(
    ...
    try:
        ...
        return await collab_svc.collaboration_service.list_dossier_sources(
            dossier_id,
            actor=_request_actor_if_oidc(request),
            status=status,
        )
...
@router.get(
    "/organizations/{organization_id}/dossiers/{dossier_id}/events",
    response_model=list[DossierEvent],
    summary="List dossier lifecycle and curation events",
)
async def list_dossier_events(
    ...
    try:
        ...
        return await collab_svc.collaboration_service.list_dossier_events(
            dossier_id,
            actor=_request_actor_if_oidc(request),
        )
    except Exception as exc:
...
@router.get(
    "/organizations/{organization_id}/dossiers/{dossier_id}/notebook",
    response_model=DossierNotebookDetail,
    summary="Get a dossier concept notebook",
)
async def get_dossier_notebook(
    request: Request,
    organization_id: UUID,
    dossier_id: UUID,
) -> DossierNotebookDetail:
...
@router.get(
    "/organizations/{organization_id}/dossiers/{dossier_id}/graph",
    response_model=DossierGraph,
    summary="Get a dossier concept graph",
)
async def get_dossier_graph(
    ...
    try:
        ...
        return await collab_svc.collaboration_service.get_dossier_graph(
            dossier_id,
            actor=_request_actor_if_oidc(request),
        )
    except Exception as exc:
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/navigate",
    response_model=DossierNavigationResult,
    summary="Navigate a dossier concept notebook",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/sync",
    response_model=DossierSyncRun,
    summary="Sync a dossier notebook provider projection",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/sources",
    response_model=DossierSource,
    summary="Create a dossier source record",
)
...
@router.patch(
    "/organizations/{organization_id}/dossiers/{dossier_id}/sources/{source_id}",
    response_model=DossierSource,
    summary="Update a dossier source record",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/notes",
    response_model=DossierNote,
    summary="Create or update a dossier notebook note",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/concepts",
    response_model=DossierConcept,
    summary="Create or update a dossier notebook concept",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/claims",
    response_model=DossierClaim,
    summary="Create or update a dossier notebook claim",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/links",
    response_model=DossierLink,
    summary="Create or update a dossier notebook graph link",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/context-packs",
    response_model=Dossier,
    summary="Attach a retrieval context pack to a dossier",
)
...
@router.post(
    "/organizations/{organization_id}/dossiers/{dossier_id}/lifecycle",
    response_model=Dossier,
    summary="Transition a dossier lifecycle status",
)
...
@router.post(
    "/organizations/{organization_id}/runtime/tasks/{task_id}/resume",
    response_model=Task,
    summary="Resume a failed runtime task after a recoverable provider or runtime issue",
)
async def resume_organization_runtime_task(
    request: Request,
    organization_id: UUID,
    task_id: UUID,
    payload: ResumeRuntimeTaskRequest = Body(...),
) -> Task:
    await _require_identity_permission(
        request,
        permission="organization.runtime.write",
        organization_id=organization_id,
    )
    payload = payload.model_copy(
        update={"actor": _resolve_organization_actor(request, payload.actor)}
    ...
    try:
        return await collab_svc.collaboration_service.resume_runtime_task(
            task_id,
            payload,
            organization_id=organization_id,
        )
...
@router.get(
    ...
    response_model=list[SystemPluginDefinition],
...
async def list_workspace_catalog_system_plugins(
    ...
    try:
        await _require_workspace_membership(request, workspace_id)
        return await collab_svc.collaboration_service.list_workspace_catalog_system_plugins(
            workspace_id
        )
    except Exception as exc:
        raise _http_error(exc) from exc
...
async def _load_system_plugin(
    ...
    *,
    ...
    plugin = await collab_svc.collaboration_service.get_system_plugin(plugin_id)
    if organization_id is not None and plugin.organization_id != organization_id:
        raise HTTPException(status_code=404, detail=f"System Plugin {plugin_id} not found")
    await _require_identity_permission(
        request,
        permission=permission,
        organization_id=organization_id or plugin.organization_id,
    )
    return plugin
...
@router.post(
    "/system-plugins",
    response_model=SystemPluginDefinition,
...
async def create_system_plugin(
    ...
    payload = payload.model_copy(update={"actor": _resolve_global_actor(request, payload.actor)})
    try:
        return await collab_svc.collaboration_service.create_system_plugin(payload)
    except Exception as exc:
        raise _http_error(exc) from exc
...
async def create_organization_system_plugin(
    request: Request,
    organization_id: UUID,
    payload: CreateSystemPluginRequest,
) -> SystemPluginDefinition:
    ...
    payload = payload.model_copy(update={"actor": _resolve_organization_actor(request, payload.actor)})
    try:
        return await collab_svc.collaboration_service.create_system_plugin(
            payload,
            scope="organization",
            organization_id=organization_id,
        )
...
async def list_system_plugins(request: Request) -> list[SystemPluginDefinition]:
    await _require_identity_permission(request, permission="provider.mcp.read")
    try:
        return await collab_svc.collaboration_service.list_system_plugins()
    except Exception as exc:
        raise _http_error(exc) from exc
...
async def list_organization_system_plugins(
    request: Request,
    organization_id: UUID,
) -> list[SystemPluginDefinition]:
    await _require_identity_permission(
...
@router.get("/system-plugins/{plugin_id}", response_model=SystemPluginDefinition)
async def get_system_plugin(request: Request, plugin_id: UUID) -> SystemPluginDefinition:
    try:
        return await _load_system_plugin(
            request,
            plugin_id,
            permission="provider.mcp.read",
        )
...
@router.get(
    "/organizations/{organization_id}/system-plugins/{plugin_id}",
    response_model=SystemPluginDefinition,
)
async def get_organization_system_plugin(
    request: Request,
    organization_id: UUID,
    plugin_id: UUID,
) -> SystemPluginDefinition:
...
@router.patch("/system-plugins/{plugin_id}", response_model=SystemPluginDefinition)
async def update_system_plugin(
    request: Request,
    plugin_id: UUID,
    payload: UpdateSystemPluginRequest,
) -> SystemPluginDefinition:
    await _load_system_plugin(request, plugin_id, permission="provider.mcp.write")
    payload = payload.model_copy(update={"actor": _resolve_global_actor(request, payload.actor)})
    try:
        return await collab_svc.collaboration_service.update_system_plugin(plugin_id, payload)
    except Exception as exc:
        raise _http_error(exc) from exc
...
async def update_organization_system_plugin(
    request: Request,
    organization_id: UUID,
    plugin_id: UUID,
    payload: UpdateSystemPluginRequest,
) -> SystemPluginDefinition:
    await _load_system_plugin(
        request,
        plugin_id,
        permission="provider.mcp.write",
        organization_id=organization_id,
...
@router.delete("/system-plugins/{plugin_id}", response_model=dict)
async def delete_system_plugin(
    request: Request,
    plugin_id: UUID,
    payload: DeleteSystemPluginRequest = Body(...),
) -> dict[str, bool | str]:
    await _load_system_plugin(request, plugin_id, permission="provider.mcp.write")
    payload = payload.model_copy(update={"actor": _resolve_global_actor(request, payload.actor)})
    try:
        return await collab_svc.collaboration_service.delete_system_plugin(plugin_id, payload)
    except Exception as exc:
        raise _http_error(exc) from exc
...
async def delete_organization_system_plugin(
    request: Request,
    organization_id: UUID,
    plugin_id: UUID,
    payload: DeleteSystemPluginRequest = Body(...),
...
@router.post("/system-plugins/{plugin_id}/sync", response_model=SystemPluginSyncResult)
async def request_system_plugin_sync(
    request: Request,
    plugin_id: UUID,
    payload: RequestSystemPluginSyncRequest,
) -> SystemPluginSyncResult:
    plugin = await _load_system_plugin(
        request,
        plugin_id,
    ...
    try:
        return await collab_svc.collaboration_service.request_system_plugin_sync(
            plugin_id,
            payload,
        )
    except Exception as exc:
...
@router.post(
    "/organizations/{organization_id}/system-plugins/{plugin_id}/sync",
    response_model=SystemPluginSyncResult,
)
async def request_organization_system_plugin_sync(
    request: Request,
    organization_id: UUID,
    plugin_id: UUID,
    payload: RequestSystemPluginSyncRequest,
...
@router.get("/system-plugins/{plugin_id}/sync-jobs", response_model=list[SystemPluginSyncJob])
async def list_system_plugin_sync_jobs(
    request: Request,
    plugin_id: UUID,
    limit: int = Query(default=20, ge=1, le=100),
) -> list[SystemPluginSyncJob]:
    await _load_system_plugin(request, plugin_id, permission="provider.mcp.read")
    try:
        return await collab_svc.collaboration_service.list_system_plugin_sync_jobs(
            plugin_id,
            limit=limit,
        )
    except Exception as exc:
...
@router.get(
    "/organizations/{organization_id}/system-plugins/{plugin_id}/sync-jobs",
    response_model=list[SystemPluginSyncJob],
)
async def list_organization_system_plugin_sync_jobs(
    request: Request,
    organization_id: UUID,
    plugin_id: UUID,
    limit: int = Query(default=20, ge=1, le=100),
...
@router.get(
    "/system-plugins/{plugin_id}/tools",
    response_model=list[SystemPluginCapabilityDefinition],
)
async def list_system_plugin_tools(
    ...
    await _load_system_plugin(request, plugin_id, permission="provider.mcp.read")
    try:
        return await collab_svc.collaboration_service.list_system_plugin_tools(plugin_id)
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.get(
    "/system-plugins/{plugin_id}/resources",
    response_model=list[SystemPluginCapabilityDefinition],
)
async def list_system_plugin_resources(
    ...
    await _load_system_plugin(request, plugin_id, permission="provider.mcp.read")
    try:
        return await collab_svc.collaboration_service.list_system_plugin_resources(plugin_id)
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.get(
    "/system-plugins/{plugin_id}/prompts",
    response_model=list[SystemPluginCapabilityDefinition],
)
async def list_system_plugin_prompts(
    ...
    await _load_system_plugin(request, plugin_id, permission="provider.mcp.read")
    try:
        return await collab_svc.collaboration_service.list_system_plugin_prompts(plugin_id)
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.get(
    ...
    response_model=list[WorkspaceSystemPlugin],
...
async def list_workspace_system_plugins(
    ...
    try:
        await _require_workspace_membership(request, workspace_id)
        return await collab_svc.collaboration_service.list_workspace_system_plugins(workspace_id)
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.get(
    ...
    response_model=list[WorkspacePluginTool],
    summary="List System Plugin tools available in a workspace",
)
async def list_workspace_plugin_tools(
    request: Request,
    workspace_id: UUID,
) -> list[WorkspacePluginTool]:
    try:
        await _require_workspace_membership(request, workspace_id)
        return await collab_svc.collaboration_service.list_workspace_plugin_tools(workspace_id)
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.get(
    ...
    response_model=list[WorkspacePluginResource],
...
async def list_workspace_plugin_resources(
    ...
    try:
        await _require_workspace_membership(request, workspace_id)
        return await collab_svc.collaboration_service.list_workspace_plugin_resources(workspace_id)
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.get(
    ...
    response_model=list[WorkspacePluginPrompt],
    summary="List System Plugin prompt templates available in a workspace",
)
async def list_workspace_plugin_prompts(
    request: Request,
    workspace_id: UUID,
) -> list[WorkspacePluginPrompt]:
    try:
        await _require_workspace_membership(request, workspace_id)
        return await collab_svc.collaboration_service.list_workspace_plugin_prompts(workspace_id)
    except Exception as exc:
        raise _http_error(exc) from exc
...
@router.put(
    "/workspaces/{workspace_id}/system-plugins/{plugin_id}",
    response_model=WorkspaceSystemPlugin,
...
async def attach_workspace_system_plugin(
    ...
    try:
        return await collab_svc.collaboration_service.attach_workspace_system_plugin(
            workspace_id,
            payload,
        )
    except Exception as exc:
...
async def update_workspace_system_plugin(
    ...
    try:
        return await collab_svc.collaboration_service.update_workspace_system_plugin(
            workspace_id,
            plugin_id,
            payload,
        )
...
async def delete_workspace_system_plugin(
    ...
    workspace_id: UUID,
    plugin_id: UUID,
    payload: DeleteWorkspaceSystemPluginRequest = Body(...),
) -> dict[str, bool | str]:
    actor = await _require_workspace_permission(
        request,
        workspace_id,
    ...
    try:
        return await collab_svc.collaboration_service.delete_workspace_system_plugin(
            workspace_id,
            plugin_id,
            payload,
        )
